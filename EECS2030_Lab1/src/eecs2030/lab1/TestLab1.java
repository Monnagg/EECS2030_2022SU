...
public class TestLab1 {
	...
	@Test
	public void test141_alternatingCaps() {
		
		Pair testCase = TestLab1.randomString(5);
		String error = String.format("alternatingCaps(\"%s\") failed", testCase.in);
		System.out.println(testCase.in + " in---------------- exp  " + testCase.exp);
		assertEquals(testCase.exp, Lab1.alternatingCaps(testCase.in));
